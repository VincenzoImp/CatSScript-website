                    ...
                    <nav class="sidebar card py-2 mb-4">
                        <ul class="nav flex-column" id="nav_accordion">
                            ...
                            <li class="nav-item has-submenu">
                                <a class="nav-link" > Selectors </a>
                                <ul class="submenu collapse">
                                    <li><a class="nav-link learn-link" id="simple_selectors">Simple selectors</a></li>
                                    <li><a class="nav-link learn-link" id="pseudoClass_selectors">Pseudo-class selectors</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link learn-link" id="properties"> Properties </a>
                            </li>
                            <div class="card mb-5 border-0 bg-transparent">
                                <img src="../../assets/img/learnCSS-img.svg" class="card-img-custom">
                            </div>
                        </ul>
                    </nav>
                </div>
