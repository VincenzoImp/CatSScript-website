                        ...
                        <ul class="nav flex-column" id="nav_accordion">
                            ...
                            <li class="nav-item has-submenu">
                                ...
                                <ul class="submenu collapse">
                                    <li><a class="nav-link learn-link" id="headings_paragraphs">Headings and paragraphs</a></li>
                                    <li><a class="nav-link learn-link" id="links_images">Links and images</a></li>
                                    <li><a class="nav-link learn-link" id="tables_lists_containers">Tables, lists and containers</a> </li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link learn-link" id="forms"> Forms </a>
                            </li>
                            <div class="card mb-5 border-0 bg-transparent">
                                <img src="../../assets/img/learnHTML-img.svg" class="card-img-custom">
                            </div>
                        </ul>
                    </nav>
                </div>
